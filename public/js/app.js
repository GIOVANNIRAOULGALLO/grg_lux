...
function filterOpen() {
  ...
  if (accordion.style.visibility == "hidden") {
    ...
    accordion.style.visibility = "visible"; // INSERT CONTENT

    accordion.append(accordionContent); // RESET HEIGHT

    accordion.style.height = "auto";
  } else {
    // THEN SET ACCORDION CONTENT TO EMPTY
    accordion.style.innerHTML = ""; // SET ACCORDION SIZE TO 0

    accordion.style.height = 0; // HIDDEN ACCORDION
...
var c = window.location; // FUNCTION WHEN WINDOW RESIZE
